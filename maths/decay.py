...
def Gam_get(model: str, datW="../Data/Width_tot/"):
    ...
    model : str
            ...
            Available models:
                ...
                Lmu-Ltau_boson
    datW : str, optional
            Location of the width data files (default is '../Data/Width_tot/')
            The file corresponding to the width data sould have a
            structure as (Mass, Full Width, Partial to el, Partial to
            mu, partial to tau, partial to hadrons) and should be named
            'width_<model>.csv' where model is the same name as enters
            as an input to this file. For width calculation, the
            coupling should be one. If there is no activity in a
            particular channel, it should be full of zeros and not
            missing.
    Returns
    -------
